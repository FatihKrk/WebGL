...
{
    public List<GameObject> parentRoots; // Birden fazla obje atanabilecek

    public GameObject targetPrefab;

    void Start()
    {
        if (parentRoots == null || parentRoots.Count == 0 || targetPrefab == null) return;
        ...
        foreach (GameObject root in parentRoots)
        {
            ...
            foreach (MeshRenderer rend in meshRenderers)
            {
                ...
                // 1) Tabandaki uygun üçgenleri bul
