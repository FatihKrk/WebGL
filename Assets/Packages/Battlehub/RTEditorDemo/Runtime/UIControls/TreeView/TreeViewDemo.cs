...
namespace Battlehub.UIControls
{
    ...
    public class TreeViewDemo : MonoBehaviour
    {
        ...
        private List<GameObject> rootGo = new List<GameObject>();
        ...
        private void Start()
        {
            ...
            GameObject obj1 = GameObject.FindGameObjectWithTag("ParentObject");
            rootGo.Add(obj1);
        ...
        private void OnItemDataBinding(object sender, TreeViewItemDataBindingArgs e)
        {
            ...
            {   
                ...
                GameObject obj = allObjects.FirstOrDefault(obj => obj.name.Trim() == dataItem.name.Trim());
                if(obj != null)
                {
